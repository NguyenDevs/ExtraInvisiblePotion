...
public final class ExtraInvisiblePotion extends JavaPlugin {
        ...
        public void onEnable() {
                ...
                this.getServer().getPluginManager().registerEvents(new InvisibleCraftingGuiListener(craftingGui, this.messageManager), this);
                this.getServer().getPluginManager().registerEvents(new ProjectileInvisibilityListener(this.configManager), this);
                ...
                Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&7[&fEIP&7] &aExtraInvisiblePotion plugin enabled successfully."));
        }
        ...
        public void onDisable() {
                ...
                Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&7[&fEIP&7] &cExtraInvisiblePotion plugin disabled."));
        }
        ...
        public void printLogoEIP() {
                ...
                Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&8 ╚══════╝╚═╝╚═╝    "));
                Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', ""));
                Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&f Extra Invisible Potion"));
                Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&6 Version " + this.getDescription().getVersion()));
